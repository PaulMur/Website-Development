...
<meta charset="utf-8">
<title>MiHost - About Us | Reliable hosting at great prices</title>
...
<div class="span5 Featimg"> <img src="images/mihost.png" alt="feature"></div>
<div class="span7">
<h1>About Us</h1>
<h3>MI Host - We <span style="color:green;">host</span> your needs!</h3>
<p>We run the latest software to improve your hosting experience. We work day to day improving features to satisfy you guys!</p>
<ul class="ticklist">
...
<h1>About Us</h1>
<h3>All about your friendly ISP.</h3>
<div style="width: 100%; height: 3px; background-color: #64B5B6;"></div>
</div>
</div><p><br /><br /><br />MI HOST is a small business that was started by Paul Murdoch and is now currently a branch of <a href="http://adloc8tor.com">Adlocator South Africa (Pty) Ltd</a>. Here at MI HOST we treat all our customers with the utmost respect and we always work for you!</p>
<p>We started out in late 2012 known as ITC WEB, launching website hosting at first and slowly growing into bigger and better packages and now offering VPS and ADSL solutions.<br />
<br />We changed our name to MI HOST in 2013. MI HOST is still a small company and thus we do not own a call centre at this time, but we hope to have an amazing call centre in the future!</p>
<p>We are always ready and willing to provide you with whatever your hosting needs are!</p><br /><br /><br /><br />
<!--<div class="row-fluid">
<div class="span6 features"> <img src="images/setup_icon.png" alt="icon">
<h4>Instant site hosting setup</h4>
<p>When you have paid for an invoice your hosting service will be created instantly. Our recommended payment methods are PayFast!</p>
</div>
<div class="span6 features"> <img src="images/backup_icon.png" alt="icon">
<h4>Daily Backups</h4>
<p>We take backups and save to a server on our main server and a separate backup to a dedicated backup server.</p>
</div>
</div>
<div class="row-fluid">
<div class="span6 features"> <img src="images/git_icon.png" alt="icon">
<h4>Suported Code</h4>
<p>We Support all Linux based web codes! We will be launching our Windows Hosting soon.</p>
</div>
<div class="span6 features"> <img src="images/script_icon.png" alt="icon">
<h4>280+ Install Scripts</h4>
<p>All hosting accounts come with over 280 Auto-Installer scripts, that can be installed using the Softaculous control panel.</p>
</div>
</div>
<div class="row-fluid">
