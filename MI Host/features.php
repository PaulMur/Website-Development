...
<meta charset="utf-8">
<title>MiHost - Shared Hosting Features</title>
...
<h3>Providing superb shared hosting for all!</h3>
...
<h3 style="color: #FFF;">Amazing features we have available for you.</h3>
<div style="width: 100%; height: 3px; background-color: #64B5B6;"></div>
</div>
</div>
<div class="row-fluid">
...
<p>When you have paid for an invoice your hosting service will be created instantly. Our recommended payment method is PayFast for instant setup!</p>
</div>
<div class="span6 features"> <img src="images/backup_icon.png" alt="icon">
<h4>Daily Backups</h4>
<p>Daily backups are taken on our shared hosting platform, these are regular backups and we keep a large amount of backups and can easily retrieve one for you any time of the day.</p>
</div>
</div>
<div class="row-fluid">
<div class="span6 features"> <img src="images/git_icon.png" alt="icon">
<h4>Suported Code</h4>
<p>We currently run CPanel web servers which suport a variety of code to bring you the flexibility that you require.</p>
</div>
