...
<html lang="en-US">
	<head>
		...
		<meta charset="utf-8">
		<title>SG Sponsors | The Ultimate Gaming clan in South Africa and EU</title>
	...
	<body class="home page page-id-26 page-template page-template-tmp-no-title-php">
					...
					<div class="nav-collapse collapse">
						<div class="menu-main-container">
							<ul class="nav">
								...
								<li class="current-menu-parent"><a href="sponsors.php">Sponsors</a></li>
								<li class="dropdown">
									<a href="#">The clan</a>
		...
		<div id="myModalL" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				<div id="LoginWithAjax" class="default">
					...
					<form name="LoginWithAjax_Form" id="LoginWithAjax_Form" action="" method="post">
			...
			<div class="title_wrapper container">
					<div class="span12">
						<div class="span6">
							<h1>The Sponsor Legends</h1>
						</div>
						<div class="breadcrumbs">
							<strong><a href="index.php">Home</a> / The sponsors</strong>
						</div>
					</div>
			</div>
		<div class="container portfolio">
			<div class="row">
				<div class="span8">
					...
					<div id="myCarousel">
						<img width="100%" height="450" src="img/sponsor.jpg"></img>
					</div>
					<div class="pview">
						<a target="_blank" href="mailto://management@serenitygaming.co.za" class="button-medium">Email management</a>
					</div>
					<!-- /span8 -->
				</div>
				<div class="span4">
					<div class="wcontainer pinfo">
						<p><span class="icon-info-sign"></span> September 22, 2015</p>
						<span class="icon-user"></span> Serenity Gaming
					</div>
					<div class="wcontainer psummary">
						<p>Welcome to Serenity Gaming, We are a small clan from South Africa and EU. Currently we are entered into the Do Gaming League for League of Legends which is a well known MOBA (Multiplayer Online Battle Arena) and consists of 5 players per team. It is a very broadly played game, competitions for this game range across the entire globe.</p>
                        
						<p>Do Gaming League – the largest and most recognised year-long league with gamers competing online from all over South Africa! (<a href="http://www.dogamingleague.co.za/" target="_blank">DGL</a>). Our team is heading up to the Do Gaming League LAN Championships in October, beginning 9th and we are desperately looking for a sponsor for our Clan.</p>
					</div>
				</div>
				<!-- /span4 -->
			</div>
		...
		<footer class="container">
			...
			<div class="copyright span12">
				...
				<div class="social">
					<a data-original-title="Youtube" data-toggle="tooltip" class="youtube" target="_blank" href="https://www.youtube.com/channel/UCtntoUGevcH7yzvwfZRka4Q"><i class="fa fa-youtube"></i> </a>
					<a data-original-title="Twitch" data-toggle="tooltip" class="twitch" target="_blank" href="http://www.dogamingleague.co.za/clan/sgza"><i class="fa fa-gamepad"></i></a>
					<a data-original-title="Google plus" data-toggle="tooltip" class="google-plus" target="_blank" href="https://plus.google.com/u/0/b/105330282794239200930/105330282794239200930/about"><i class="fa fa-google-plus"></i></a>
					<a data-original-title="Twitter" data-toggle="tooltip" class="twitter" target="_blank" href="https://twitter.com/SerenityGamingZ"><i class="fa fa-twitter"></i></a>
					<a data-original-title="Facebook" data-toggle="tooltip" class="facebook" target="_blank" href="https://www.facebook.com/SerenityGamingZA"><i class="fa fa-facebook"></i></a>
				</div>
			</div>
		</footer>
		</div>
