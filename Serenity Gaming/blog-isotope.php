		...
		<div id="myModalL" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="title_wrapper container">
					<div class="span12">
						...
						<div class="breadcrumbs"><strong><a href="index.php">Home</a> / Blog Isotope</strong></div>
					</div>
			</div>

			<div class="container boxed blog normal-page container-wrap">
				<div class="row">
					  <div class="isoblog span12">
      <!-- new line -->
      <div class="blog-post" >
        <div class="blog-image img_thumb entry-thumb">
          <a href="blog-post.html"><img src="./img/defaults/817x320.jpg" class="attachment-small wp-post-image"></a>
        ...
        <div class="blog-content">
          <h2>
            <a href="blog-post.html">Etiam massa mauris fermentum a congue id</a>
          </h2>
          <p>
      ...
      <div class="blog-post" >
        <div class="blog-image img_thumb entry-thumb">
          ...
          <div class="blog-date isodate-blog">
            ...
            17</span>
            <div class="plove">
              <a title="Love this" id="heart-love-496" class="heart-love" href="#" name="heart-love-496"><span class="heart-love-count">47</span></a>
            </div>
          </div>
          <div class="blog-rating">
            <div class="overall-score">
        ...
        <div class="blog-content">
          <h2>
            <a href="blog-post.html">Curabitur lorem mauris dictum et tempus</a>
          </h2>
          <p>
            Sed commodo, libero ut dignissim imperdiet, lorem nibh bibendum nisi, vel blandit est eros sit amet elit. Mauris nec arcu vel tellus aliquam congue. Mauris fermentum sem ut tortor ultricies dictum. Praesent at porttitor mauris. Curabitur pulvinar suscipit tortor venenatis […]
          </p>
        ...
        <div class="blog-info">
          <div class="post-pinfo">
            <span class="icon-user"></span><a>admin</a><span class="icon-comment"></span>   <a data-toggle="tooltip" href="#" data-original-title="2 Comments">2 Comments</a>   <a href="#">Fantasy,</a> <a href="#">Online,</a> <a href="#">Shooter,</a> <a href="#">Strategy,</a>
          </div><!-- post-pinfo -->
          <a class="button-small" href="#">Read more</a>
          <div class="clear"></div>
        </div><!-- blog-info -->
      ...
      <div class="blog-post" >
        <div class="blog-image img_thumb entry-thumb">
          ...
          <div class="blog-date isodate-blog">
            ...
            17</span>
            <div class="plove">
              <a title="Love this" id="heart-love-491" class="heart-love" href="#" name="heart-love-491"><span class="heart-love-count">25</span></a>
            </div>
          </div>
          <div class="blog-rating">
            <div class="overall-score">
        ...
        <div class="blog-content">
          <h2>
            <a href="blog-post.html">Morbi vel ipsum vel augue mattis ultricies non et mauris</a>
          </h2>
          <p>
            Sed commodo, libero ut dignissim imperdiet, lorem nibh bibendum nisi, vel blandit est eros sit amet elit. Mauris nec arcu vel tellus aliquam congue. Mauris fermentum sem ut tortor ultricies dictum. Praesent at porttitor mauris. Curabitur pulvinar suscipit tortor venenatis […]
          </p>
        ...
        <div class="blog-info">
          <div class="post-pinfo">
            <span class="icon-user"></span><a>admin</a><span class="icon-comment"></span>   <a data-toggle="tooltip" href="#" data-original-title="2 Comments">2 Comments</a>   <a href="#">Classics,</a> <a href="#">Fantasy,</a> <a href="#">Online,</a> <a href="#">RPG,</a>
          </div><!-- post-pinfo -->
          <a class="button-small" href="#">Read more</a>
          <div class="clear"></div>
        </div><!-- blog-info -->
      ...
      <div class="blog-post">
        <div class="blog-image img_thumb entry-thumb">
          ...
          <div class="blog-date isodate-blog">
            ...
            04</span>
            <div class="plove">
              <a title="Love this" id="heart-love-82" class="heart-love" href="#" name="heart-love-82"><span class="heart-love-count">23</span></a>
            </div>
          </div>
          <div class="blog-rating">
            <div class="overall-score">
        ...
        <div class="blog-content">
          <h2>
            <a href="blog-post.html">Duis lacinia nisi vel lorem scelerisque interdum</a>
          </h2>
          <p>
            Sed commodo, libero ut dignissim imperdiet, lorem nibh bibendum nisi, vel blandit est eros sit amet elit. Mauris nec arcu vel tellus aliquam congue. Mauris fermentum sem ut tortor ultricies dictum. Praesent at porttitor mauris. Curabitur pulvinar suscipit tortor venenatis […]
          </p>
        ...
        <div class="blog-info">
          <div class="post-pinfo">
            <span class="icon-user"></span><a> admin</a>  <span class="icon-comment"></span>   <a data-toggle="tooltip" href="#" data-original-title="2 Comments">2 Comments</a>   <a href="#">Classics,</a> <a href="#">RPG,</a> <a href="#">Strategy,</a>
          </div><!-- post-pinfo -->          <a class="button-small" href="#">Read more</a>
          <div class="clear"></div>
        </div><!-- blog-info -->
      </div><!-- /.blog-post -->
    </div>
