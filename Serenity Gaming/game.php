...
<meta charset="utf-8">
<title>SG Teams | The Ultimate Gaming clan in South Africa and EU</title>
    ...
    <div class="nav-collapse collapse">
      <div class="menu-main-container">
        <ul class="nav">
          ...
          <li class="dropdown current-menu-parent"> <a href="#">The clan</a>
...
<div class="title_wrapper container">
  <div class="span12">
    ...
    <div class="breadcrumbs"> <strong><a href="#">Home</a> / Teams</strong> </div>
  </div>
</div>
      ...
      <div class="template-wrapper">
          ...
          <div class="block boxed full-width-section parallax_section parallax-no-padding parallax-no-padding-top bgpat">
            <div class="light">
              <div class="block block-text_block span6 first cf">
                <div class="highlight-no-margin mt100">
                  <div>
                    <p><span class="fz48"><img src="img/logo.png"</span></p>
                    <p><span class="fz26">Main league of legends team</span></p>
                  </div>
                </div>
              </div>
              <div id="block-3" class="block block-animated_block span6  cf">
                <div class="animated-no-margin"><img alt="" src="./img/defaults/305x305.jpg" data-animation="fade-in-from-right" data-delay="1000" class="img-with-animation"></div>
              </div>
              <div class="clear"></div>
            </div>
          </div>
        ...
        <div id="block-4" class="block block-text_block span6 first cf">
          ...
          <div class="wcontainer">
            <p>Team members, currently in the DGC 2015 Championships. Find us here on the confirmation page, the team will be prepping to go to DGC in Johannesburg in 
              a few weeks.</p>
            <p> <a href="http://www.dogamingleague.co.za/_player.php?p=27143" target="_blank">sG` Yogisip</a><br />
              <a href="http://www.dogamingleague.co.za/_player.php?p=26837" target="_blank">sG` BaronVonBondage</a><br />
              <a href="http://www.dogamingleague.co.za/_player.php?p=27575" target="_blank">sG` Preacher D</a><br />
              <a href="http://www.dogamingleague.co.za/_player.php?p=43504" target="_blank">sG` Navoi</a><br />
              <a href="http://www.dogamingleague.co.za/_player.php?p=39662" target="_blank">sG` Vanity Smurf</a><br />
              <a href="http://www.dogamingleague.co.za/_player.php?p=21842" target="_blank">sG` Wasabi Za</a><br />
              <a href="http://www.dogamingleague.co.za/_player.php?p=42846" target="_blank">sG` Dark Biznis</a><br />
            </p>
          </div>
        </div>
        <div id="block-5" class="block block-skills_block span6  cf">
          <div class="title-wrapper">
            <h3 class="widget-title">Team Sponsor</h3>
            <div class="clear"></div>
          </div>
          <h6>
          Team currently unsponsored.
          <h6>
        </div>
        <div class="clear"></div>
      </div>
...
<footer class="container">
  <div class="span12">
    ...
    <div class="footer_widget span3">
      ...
      <ul class="review">
        <li>
          <div class="img"> <a rel="bookmark" href="#"> <img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/65-57x57.jpg"> <span class="overlay-link"></span> </a> </div>
        ...
        <li>
          <div class="img"> <a rel="bookmark" href="#"> <img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/08/2-57x57.jpg"> <span class="overlay-link"></span> </a> </div>
        ...
        <li>
          <div class="img"> <a rel="bookmark" href="#"> <img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/05/8-57x57.jpg"> <span class="overlay-link"></span> </a> </div>
        ...
        <li>
          <div class="img"> <a rel="bookmark" href="#"> <img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/57-57x57.jpg"> <span class="overlay-link"></span> </a> </div>
