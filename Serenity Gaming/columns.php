			...
			<div class="title_wrapper container">
					<div class="span12">
						...
						<div class="breadcrumbs">
							<strong><a href="#">Home</a> / Columns</strong>
						</div>
					</div>
			</div>
						...
						<div class="template-wrapper">
							<div class="block block-page_header_block span12 first cf">
								<div class="span12 block-title centered">
									<h2>YOU CAN CHOOSE BETWEEN BOXED...</h2>
									<p></p>
								</div>
							...
							<div class="clear"></div>
							<div class="block block-text_block span3 first cf">
								<div class="wcontainer">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce velit tortor, dictum in gravida nec, aliquet non lorem. Donec vestibulum justo a diam ultricies pellentesque illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo nemo enim ipsam voluptatem non ultricies dicta sunt etiam eget mi enim, non ultricies nisi voluptatem. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis ligula. Vestibulum id porta felis euismod.</p>
								</div>
							</div>
							<div class="block block-text_block span3  cf">
								<div class="wcontainer">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce velit tortor, dictum in gravida nec, aliquet non lorem. Donec vestibulum justo a diam ultricies pellentesque illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo nemo enim ipsam voluptatem non ultricies dicta sunt etiam eget mi enim, non ultricies nisi voluptatem. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis ligula. Vestibulum id porta felis euismod.</p>
								</div>
							</div>
							...
							<div class="block block-text_block span2 first cf">
								<div class="wcontainer">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce velit tortor, dictum in gravida nec, aliquet non lorem. Donec vestibulum justo a diam ultricies pellentesque illo inventore veritatis et.</p>
								</div>
							</div>
							<div class="block block-text_block span2  cf">
								<div class="wcontainer">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce velit tortor, dictum in gravida nec, aliquet non lorem. Donec vestibulum justo a diam ultricies pellentesque illo inventore veritatis et.</p>
								</div>
							</div>
