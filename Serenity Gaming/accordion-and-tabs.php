...
<html lang="en-US">
	<head>
		...
		<!-- CSS -->
		<link rel="stylesheet" href="css/pb-view.css">
	...
	<body class="home page page-id-26 page-template page-template-tmp-no-title-php">
		...
		<div id="myModalL" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="title_wrapper container">
					<div class="span12">
						<div class="span6">
							<h1>Accordion and tabs</h1>
						</div>
						<div class="breadcrumbs">
							<strong><a href="#">Home</a> / Accordion and tabs</strong>
						</div>
					</div>
			</div>
			<div class="page normal-page container">
				<div class="row">
					<div class="span12">
						<div class="template-wrapper">
							<div class="block span12 first cf">
								<div class="span12 block-title centered">
									<h2>EASY PEASY TO SET UP</h2>
									<p>Fresh from Boostraps hoven.</p>
								</div>
								<div class="span12 block-divider"></div>
							</div>
							<div class="block block-tabs_block span6 first cf">
								<div class="title-wrapper">
									<h3 class="widget-title">Accordion</h3>
									<div class="clear"></div>
								</div>
								<div role="tablist" id="block_accordion_wrapper_76" class="block_accordion_wrapper  ui-accordion ui-widget ui-helper-reset">
									<a tabindex="0" aria-selected="true" aria-controls="ui-accordion-block_accordion_wrapper_76-panel-0" id="ui-accordion-block_accordion_wrapper_76-header-0" role="tab" class="tab-head accordion-heading ui-accordion-header ui-helper-reset ui-state-default ui-accordion-icons ui-accordion-header-active ui-state-active ui-corner-top" style="-moz-user-select: none;-webkit-user-select: none;" onselectstart="return false;">&nbsp;&nbsp;Collapsible Group Item #1</a>
									<div aria-hidden="false" aria-expanded="true" role="tabpanel" aria-labelledby="ui-accordion-block_accordion_wrapper_76-header-0" id="ui-accordion-block_accordion_wrapper_76-panel-0" class="active tab-body cf wcontainer ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active">
										<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</p>
									</div>
									<a tabindex="-1" aria-selected="false" aria-controls="ui-accordion-block_accordion_wrapper_76-panel-1" id="ui-accordion-block_accordion_wrapper_76-header-1" role="tab" class="tab-head accordion-heading ui-accordion-header ui-helper-reset ui-state-default ui-accordion-icons ui-corner-all" style="-moz-user-select: none;-webkit-user-select: none;" onselectstart="return false;">&nbsp;&nbsp;Collapsible Group Item #2</a>
									<div aria-hidden="true" aria-expanded="false" role="tabpanel" aria-labelledby="ui-accordion-block_accordion_wrapper_76-header-1" id="ui-accordion-block_accordion_wrapper_76-panel-1" class="tab-body cf wcontainer ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom">
										<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</p>
									</div>
									<a tabindex="-1" aria-selected="false" aria-controls="ui-accordion-block_accordion_wrapper_76-panel-2" id="ui-accordion-block_accordion_wrapper_76-header-2" role="tab" class="tab-head accordion-heading ui-accordion-header ui-helper-reset ui-state-default ui-corner-all ui-accordion-icons" style="-moz-user-select: none;-webkit-user-select: none;" onselectstart="return false;">&nbsp;&nbsp;Collapsible Group Item #3</a>
									<div aria-hidden="true" aria-expanded="false" role="tabpanel" aria-labelledby="ui-accordion-block_accordion_wrapper_76-header-2" id="ui-accordion-block_accordion_wrapper_76-panel-2" class="tab-body cf wcontainer ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom">
										<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.</p>
									</div>
								</div>
							</div>
							<div class="block block-tabs_block span6  cf">
								<div class="title-wrapper">
								...
								<div id="block_tabs_68" class="block_tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
									<div class="tab-inner">
										<ul role="tablist" class="nav cf nav-tabs ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
											<li aria-selected="true" aria-labelledby="ui-id-1" aria-controls="tab-home1" tabindex="0" role="tab" class="ui-tabs-active ui-state-default ui-corner-top ui-state-active"><a id="ui-id-1" tabindex="-1" role="presentation" class="ui-tabs-anchor" href="#tab-home1">Home</a></li>
											<li aria-selected="false" aria-labelledby="ui-id-2" aria-controls="tab-profile2" tabindex="-1" role="tab" class="ui-state-default ui-corner-top"><a id="ui-id-2" tabindex="-1" role="presentation" class="ui-tabs-anchor" href="#tab-profile2">Profile</a></li>
											<li aria-selected="false" aria-labelledby="ui-id-3" aria-controls="tab-messages3" tabindex="-1" role="tab" class="ui-state-default ui-corner-top"><a id="ui-id-3" tabindex="-1" role="presentation" class="ui-tabs-anchor" href="#tab-messages3">Messages</a></li>
											<li aria-selected="false" aria-labelledby="ui-id-4" aria-controls="tab-settings4" tabindex="-1" role="tab" class="ui-state-default ui-corner-top"><a id="ui-id-4" tabindex="-1" role="presentation" class="ui-tabs-anchor" href="#tab-settings4">Settings</a></li>
										</ul>
										<div aria-hidden="false" aria-expanded="true" style="display: block;" role="tabpanel" aria-labelledby="ui-id-1" id="tab-home1" class="tab tab-content ui-tabs-panel ui-widget-content ui-corner-bottom">
											<p>Nincidunt ut laoreet dolore magnaaliquam erat luptatum nulla facilisi luptatum zzril delenit augueea commozzril delenit augueea commo duis dolorecommo duis dolorecommozzril delenit augueea commo duis dolorecommo duis dolore te feugait nulla duis dolore te feugait nulla facilisi luptatum zzril facilisi. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
										</div>
										...
										<div aria-hidden="true" aria-expanded="false" style="display: none;" role="tabpanel" aria-labelledby="ui-id-4" id="tab-settings4" class="tab tab-content ui-tabs-panel ui-widget-content ui-corner-bottom">
											<p>Etiam eget mi enim, non ultricies nisi voluptatem, illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo nemo enim ipsam voluptatem non ultricies dicta sunt etiam eget mi enim, non ultricies nisi voluptatem. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis ligula. Vestibulum id porta felis euismod. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
										</div>
									</div>
								</div>
							</div>
							<div id="block-4" class="block block-tabs_block span12 first cf">
								<div class="title-wrapper">
									<h3 class="widget-title">EASILY SELECT THE TABS POSITION!</h3>
									<div class="clear"></div>
								</div>
								<div id="block_tabs_75" class="block_tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
									<div class="tabs-left">
										<ul role="tablist" class="nav cf nav-tabs ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
											<li aria-selected="true" aria-labelledby="ui-id-5" aria-controls="tab-section-11" tabindex="0" role="tab" class="ui-state-default ui-corner-top"><a id="ui-id-5" tabindex="-1" role="presentation" class="ui-tabs-anchor" href="#tab-section-11">Section 1</a></li>
											<li aria-selected="false" aria-labelledby="ui-id-6" aria-controls="tab-section-22" tabindex="-1" role="tab" class="ui-state-default ui-corner-top"><a id="ui-id-6" tabindex="-1" role="presentation" class="ui-tabs-anchor" href="#tab-section-22">Section 2</a></li>
											<li aria-selected="false" aria-labelledby="ui-id-7" aria-controls="tab-section-33" tabindex="-1" role="tab" class="ui-state-default ui-corner-top"><a id="ui-id-7" tabindex="-1" role="presentation" class="ui-tabs-anchor" href="#tab-section-33">Section 3</a></li>
										</ul>
										<div aria-hidden="false" aria-expanded="true" style="display: block;" role="tabpanel" aria-labelledby="ui-id-5" id="tab-section-11" class="tab tab-content ui-tabs-panel ui-widget-content ui-corner-bottom">
											<p>Nincidunt ut laoreet dolore magnaaliquam erat luptatum nulla facilisi luptatum zzril delenit augueea commozzril delenit augueea commo duis dolorecommo duis dolorecommozzril delenit augueea commo duis dolorecommo duis dolore te feugait nulla duis dolore te feugait nulla facilisi luptatum zzril facilisi. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
											<p>Asunt in anim uis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. Sunt in anim id est laborum. Allamco laboris nisi ut aliquip ex ea commodo consequat. Aser velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in anim id est laborum. Allamco laboris nisi ut aliquip ex ea commodo consequat. Aser velit esse cillum dolore eu fugiat nulla pariatur.</p>
										</div>
										<div aria-hidden="true" aria-expanded="false" style="display: none;" role="tabpanel" aria-labelledby="ui-id-6" id="tab-section-22" class="tab tab-content ui-tabs-panel ui-widget-content ui-corner-bottom">
											<p>Asunt in anim uis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. Sunt in anim id est laborum. Allamco laboris nisi ut aliquip ex ea commodo consequat. Aser velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in anim id est laborum. Allamco laboris nisi ut aliquip ex ea commodo consequat. Aser velit esse cillum dolore eu fugiat nulla pariatur.</p>
											<p>Etiam eget mi enim, non ultricies nisi voluptatem, illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo nemo enim ipsam voluptatem non ultricies dicta sunt etiam eget mi enim, non ultricies nisi voluptatem. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis ligula. Vestibulum id porta felis euismod. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
										</div>
										<div aria-hidden="true" aria-expanded="false" style="display: none;" role="tabpanel" aria-labelledby="ui-id-7" id="tab-section-33" class="tab tab-content ui-tabs-panel ui-widget-content ui-corner-bottom">
											<p>Etiam eget mi enim, non ultricies nisi voluptatem, illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo nemo enim ipsam voluptatem non ultricies dicta sunt etiam eget mi enim, non ultricies nisi voluptatem. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis ligula. Vestibulum id porta felis euismod. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
											<p>Nincidunt ut laoreet dolore magnaaliquam erat luptatum nulla facilisi luptatum zzril delenit augueea commozzril delenit augueea commo duis dolorecommo duis dolorecommozzril delenit augueea commo duis dolorecommo duis dolore te feugait nulla duis dolore te feugait nulla facilisi luptatum zzril facilisi. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
										</div>
									</div>
							...
							<div id="block-5" class="block block-tabs_block span12 first cf">
								<div class="title-wrapper">
									<h3 class="widget-title">TOGGLES</h3>
									<div class="clear"></div>
								</div>
								<div id="block_toggles_wrapper_52" class="block_toggles_wrapper">
									<div class="block_toggle accordion-group ">
										<a class="tab-head accordion-heading closed"><i class="icon-arrow-down"></i>&nbsp;&nbsp;Toggle 1</a>
										<div class="arrow"></div>
										<div id="0" class="tab-body cf wcontainer" style="display: none;">
											<p>Nincidunt ut laoreet dolore magnaaliquam erat luptatum nulla facilisi luptatum zzril delenit augueea commozzril delenit augueea commo duis dolorecommo duis dolorecommozzril delenit augueea commo duis dolorecommo duis dolore te feugait nulla duis dolore te feugait nulla facilisi luptatum zzril facilisi. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
										</div>
									</div>
									<div class="block_toggle accordion-group ">
										<a class="tab-head accordion-heading closed"><i class="icon-arrow-down"></i>&nbsp;&nbsp;Toggle 2</a>
										<div class="arrow"></div>
										<div id="1" class="tab-body cf wcontainer" style="display: none;">
											<p>Nincidunt ut laoreet dolore magnaaliquam erat luptatum nulla facilisi luptatum zzril delenit augueea commozzril delenit augueea commo duis dolorecommo duis dolorecommozzril delenit augueea commo duis dolorecommo duis dolore te feugait nulla duis dolore te feugait nulla facilisi luptatum zzril facilisi. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
										</div>
									</div>
									<div class="block_toggle accordion-group ">
										<a class="tab-head accordion-heading closed"><i class="icon-arrow-down"></i>&nbsp;&nbsp;Toggle 3</a>
										<div class="arrow"></div>
										<div id="2" class="tab-body cf wcontainer" style="display: none;">
											<p>Nincidunt ut laoreet dolore magnaaliquam erat luptatum nulla facilisi luptatum zzril delenit augueea commozzril delenit augueea commo duis dolorecommo duis dolorecommozzril delenit augueea commo duis dolorecommo duis dolore te feugait nulla duis dolore te feugait nulla facilisi luptatum zzril facilisi. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
											<p>Asunt in anim uis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. Sunt in anim id est laborum. Allamco laboris nisi ut aliquip ex ea commodo consequat. Aser velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in anim id est laborum. Allamco laboris nisi ut aliquip ex ea commodo consequat. Aser velit esse cillum dolore eu fugiat nulla pariatur.</p>
										</div>
									</div>
						...
						<div class="template-wrapper">
							<div id="template-wrapper-358" class="template-wrapper">
							    <div id="block-1" class="block block-parallax_block span12 first cf">
							        <div id=d33ddb48a3a039764e271e1b73193498 class='boxed full-width-section parallax_section' style='background-image: url(./img/defaults/1920x1035.jpg); background-color:'>
                                        <video  autoplay="true" loop="true" preload="auto" poster="" class="slider-video" style="left: -380px; width: 1920px;display: block;position: relative;" src="">
                                        <source src="" type="video/webm"></source>
                                        <source src="" type="video/mp4"></source>
                                        </video>
                                    <div class="light">
                                        <div id="block-2" class="block block-highlight_block span12 first cf">
                                            <div class="highlight-no-margin highlight bgpattern span12">
                                                <div class="container">
                                                    <h2>Game Addict - Unleash the power.</h2>
                                                    <a href="http://themeforest.net/item/game-addict-clan-war-gaming-theme/6771881?ref=Skywarrior" class="button-medium pull-right">Buy now!</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
