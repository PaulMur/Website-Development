...
<html lang="en-US">
	...
	<body class="home page page-id-26 page-template page-template-tmp-no-title-php">
		...
		<div class="container portfolio">
			<div class="row">
				<div class="span8">
					<div class="plove wcontainer"><a href="#"></a><a href="#" class="heart-love" id="heart-love-415" title="Love this"><span class="heart-love-count"><span class="icon-heart"></span>29</span></a></div>
					<div id="myCarousel">
						<img src="./img/defaults/350x350.jpg" alt="Alt text">
					</div>
					<div class="pview">
						...
						<ul id="list" class="portfolio-grid span12">
                          <li data-id="id-0" class="span3 Adve Fant Onli">
                            <div class="pimage">
                              <div class="pbg"></div>
                              <div class="pdisplay">
                                <a href="./img/defaults/287x222.jpg" class="vimage shadowbox">View image</a>
