		...
		<div id="sliderhome" class="container">
			<div id="layerslider" class="ls-wp-container ls-container ls-fullwidth" style="height: 300px; margin: 0px auto; width:100%;">
				...
				<div class="ls-slide" data-ls="slidedelay:9500;transition2d:5;timeshift:-3000;">
					<img src="./img/defaults/1170x203.jpg" class="ls-bg" alt="Slide background" >
					<p class="ls-l" data-ls="offsetxin:0;offsetyin:-300px;durationin:2000;delayin:200;offsetxout:-50;durationout:1000;"  style="top: 52px; left: 31px; color: rgba(255, 90, 90, 0.901961); text-transform: uppercase; font-weight: bold; font-family: 'Open Sans'; padding: 15px; border: 0px; font-size: 30px; background-color: rgb(21, 22, 29); white-space: nowrap; width: auto; height: auto;   margin-left: 0px; margin-top: 0px; display: block; "> BBPRESS FORUM AND RATING SYSTEM </p>
	    ...
	    <div class="row">
	        <div class="span12">
	        	<div>
					        	...
					        	<div class="light">
		        					<div class="block span12 first block-text_block ">
		        						<div class="mcontainer">
											...
											<p>&nbsp;</p>
											<p><a href="#">Impress your visitors</a></p>
										</div>
									</div>
									<div class="clear"></div>
								</div>
	            	...
	            	<div class="rx_isotope_ui"><ul data-lightboxcolor="ed5816" data-selectedcolor="344050" class="isotopeMenu"><li><a href="*" style="color: rgb(255, 255, 255); background: none repeat scroll 0% 0% rgb(52, 64, 80);" class="eye" data-indx="0">All</a></li><li><a href="_groupNJW0XRQ5BUGJ3WMPM75FDY2BMPLWPW7Y" style="color: rgb(255, 255, 255); background: none repeat scroll 0% 0% transparent;" class="eye" data-indx="1">Models</a></li><li><a href="_groupTY3GM2Y61EI1VI09FXX5TU92VRK9HP91" style="color: rgb(255, 255, 255); background: none repeat scroll 0% 0% transparent;" class="eye" data-indx="2">Maps</a></li><li><a href="_groupL0YQ605H6V7CVA932G4GHI53RNBKJTOV" style="color: rgb(255, 255, 255); background: none repeat scroll 0% 0% transparent;" class="eye" data-indx="3">Sketches</a></li></ul><div class="isotope_top_space"></div><div class="isotopeContainer isotope" style="position: relative; overflow: hidden; height: 890px;"><div class="isotopeItem _groupNJW0XRQ5BUGJ3WMPM75FDY2BMPLWPW7Y isotope-item" style="width: 264px; height: 280px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(0px, 0px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="0" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 92px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        ...
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                                        </div>
                                    </div>
                                </div>

                            </div>
                        </div><div class="isotopeItem _groupNJW0XRQ5BUGJ3WMPM75FDY2BMPLWPW7Y isotope-item" style="width: 264px; height: 250px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(274px, 0px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="1" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 77px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                                        </div>
                                    </div>
                                </div>
                        ...
                        </div><div class="isotopeItem _groupNJW0XRQ5BUGJ3WMPM75FDY2BMPLWPW7Y isotope-item" style="width: 264px; height: 75px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(548px, 0px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="2" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: -10.5px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                        ...
                        </div><div class="isotopeItem _groupNJW0XRQ5BUGJ3WMPM75FDY2BMPLWPW7Y isotope-item" style="width: 264px; height: 250px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(822px, 0px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="3" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 77px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                        ...
                        </div><div class="isotopeItem _groupNJW0XRQ5BUGJ3WMPM75FDY2BMPLWPW7Y isotope-item" style="width: 264px; height: 225px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(548px, 85px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="4" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 64.5px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                        ...
                        </div><div class="isotopeItem _groupTY3GM2Y61EI1VI09FXX5TU92VRK9HP91 isotope-item" style="width: 264px; height: 100px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(274px, 260px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="5" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 2px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                        ...
                        </div><div class="isotopeItem _groupTY3GM2Y61EI1VI09FXX5TU92VRK9HP91 isotope-item" style="width: 264px; height: 450px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(822px, 260px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="6" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .4);" class="beaconCircle1"></div>
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .8);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                                        </div>
                                    </div>
                                </div>
                        ...
                        </div><div class="isotopeItem _groupTY3GM2Y61EI1VI09FXX5TU92VRK9HP91 isotope-item" style="width: 264px; height: 270px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(0px, 290px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="7" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 87px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                        ...
                        </div><div class="isotopeItem _groupTY3GM2Y61EI1VI09FXX5TU92VRK9HP91 isotope-item" style="width: 264px; height: 300px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(548px, 320px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="8" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .4);" class="beaconCircle1"></div>
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .8);" class="beaconCircle2">
                        ...
                        </div><div class="isotopeItem _groupL0YQ605H6V7CVA932G4GHI53RNBKJTOV isotope-item" style="width: 264px; height: 150px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(274px, 370px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="9" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 27px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .4);" class="beaconCircle1"></div>
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .8);" class="beaconCircle2">
                                            <img alt="" src="http://skywarriorthemes.com/gameaddict/wp-content/plugins/sk_isotope_gallery/images/link_icon_beacon.png" class="isotopeItemOpenLink">
                        ...
                        </div><div class="isotopeItem _groupL0YQ605H6V7CVA932G4GHI53RNBKJTOV isotope-item" style="width: 264px; height: 250px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(274px, 530px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="10" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 77px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                        ...
                        </div><div class="isotopeItem _groupL0YQ605H6V7CVA932G4GHI53RNBKJTOV isotope-item" style="width: 264px; height: 250px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(0px, 570px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="11" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon" style="left: 84px; top: 77px;">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.4); opacity: 1; top: 0px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle1"></div>
                                        <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.8); opacity: 1; top: 12.05px; transform: matrix(1, 0, 0, 1, 0, 0);" class="beaconCircle2">
                        ...
                        </div><div class="isotopeItem _groupL0YQ605H6V7CVA932G4GHI53RNBKJTOV isotope-item" style="width: 264px; height: 250px; margin: 5px; position: absolute; left: 0px; top: 0px; transform: translate(548px, 630px) scale(1, 1); opacity: 1;">
                            <img src="./img/defaults/305x305.jpg" class="isotopeThumb">
                            <div style="background: none repeat scroll 0% 0% rgba(52, 64, 80, 0.15); opacity: 0; display: block;" data-full_url="./img/defaults/305x305.jpg" data-indx="12" class="isotopeItemOverlay">
                                <div class="rx_isotope_beacon">
                                    <div data-href="#" class="genericBeaconIsotope">
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .4);" class="beaconCircle1"></div>
                                        <div style="background-color: #344050;background: rgba(52, 64, 80, .8);" class="beaconCircle2">
