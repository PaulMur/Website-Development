		...
		<div id="myModalL" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="title_wrapper container">
					<div class="span12">
						...
						<div class="breadcrumbs"><strong><a href="#">Home</a> / Shop / Happy Ninja</strong></div>
					</div>
			...
			<div class="page normal-page container-wrap container boxed">
				<div class="row">
					<div class="span12">
						<div itemscope="" itemtype="http://schema.org/Product" class="post-53 product type-product status-publish hentry instock">
							<div class="images">
								<a href="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/hoodie_4_front.jpg" itemprop="image" class="woocommerce-main-image zoom" >
									<img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/hoodie_4_front-300x300.jpg" class="attachment-shop_single wp-post-image" alt="hoodie_4_front">
								</a>
								<div class="clear"></div>
								<div class="thumbnails">
									<a href="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/hoodie_4_back.jpg" class="zoom first">
										<img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/hoodie_4_back-90x90.jpg" class="attachment-shop_thumbnail" alt="hoodie_4_back">
									</a>
								</div>
							</div>
							<div class="summary entry-summary">
								...
								<div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
									<p itemprop="price" class="price"><span class="amount">£35</span></p>
								...
								<form class="cart" method="post" enctype="multipart/form-data">
									<div class="quantity buttons_added">
										...
										<input step="1" min="1" name="quantity" value="1" title="Qty" class="input-text qty text" type="number">
										<input value="+" class="plus" type="button">
									</div>
									<input name="add-to-cart" value="53" type="hidden">
									<button type="submit" class="single_add_to_cart_button button alt">Add to cart</button>
								</form>
								<div class="product_meta">
									<span class="posted_in">Categories: <a href="#" rel="tag">Clothing</a>, <a href="#" rel="tag">Hoodies</a>.</span>
								</div>
							</div>
							<!-- .summary -->
									...
									<div id="reviews">
										<div id="comments">
											<div itemprop="aggregateRating" itemscope="" itemtype="http://schema.org/AggregateRating">
												<div class="star-rating" title="Rated 3.00 out of 5"><span style="width:60%"><strong itemprop="ratingValue" class="rating">3.00</strong> out of 5</span></div>
												<h2><span itemprop="ratingCount" class="count">2</span> reviews for Happy Ninja</h2>
											</div>
											<ol class="commentlist">
												<li itemprop="reviews" itemscope="" itemtype="http://schema.org/Review" class="comment even thread-even depth-1" id="li-comment-44">
													<div id="comment-44" class="comment_container">
														<img alt="" src="http://0.gravatar.com/avatar/8026a390d28369f7a2befcaeb9557359?s=60&amp;d=http%3A%2F%2F0.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D60&amp;r=G" class="avatar avatar-60 photo" height="60" width="60">
														<div class="comment-text">
															...
															<p class="meta">
																<strong itemprop="author">Andrew</strong> – <time itemprop="datePublished" datetime="2013-06-07T11:54:51+00:00">June 7, 2013</time>:
															</p>
												...
												<!-- #comment-## -->
												<li itemprop="reviews" itemscope="" itemtype="http://schema.org/Review" class="comment odd alt thread-odd thread-alt depth-1" id="li-comment-45">
													<div id="comment-45" class="comment_container">
														<img alt="" src="http://1.gravatar.com/avatar/59c82b1d2c60537f900fb191b3cb611b?s=60&amp;d=http%3A%2F%2F1.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D60&amp;r=G" class="avatar avatar-60 photo" height="60" width="60">
														<div class="comment-text">
															<div itemprop="reviewRating" itemscope="" itemtype="http://schema.org/Rating" class="star-rating" title="Rated 5 out of 5">
																<span style="width:100%"><strong itemprop="ratingValue">5</strong> out of 5</span>
															</div>
															<p class="meta">
																<strong itemprop="author">Maria</strong> – <time itemprop="datePublished" datetime="2013-06-07T15:50:22+00:00">June 7, 2013</time>:
															</p>
															<div itemprop="description" class="description">
										...
										<div style="display: none;" id="review_form_wrapper">
											<div id="review_form">
												<div id="respond" class="comment-respond">
													<h3 id="reply-title" class="comment-reply-title">Add a review <small><a rel="nofollow" id="cancel-comment-reply-link" href="/gameaddict/product/happy-ninja-2/#respond" style="display:none;">Cancel reply</a></small></h3>
													<form action="http://skywarriorthemes.com/gameaddict/wp-comments-post.php" method="post" id="commentform" class="comment-form">
														<div id="comment-status"></div>
														<p class="comment-form-author"><label for="author">Name</label> <span class="required">*</span><input id="author" name="author" value="" size="30" aria-required="true" type="text"></p>
														...
														<input id="_n" name="_n" value="8af27e9e04" type="hidden"><input name="_wp_http_referer" value="/gameaddict/product/happy-ninja-2/" type="hidden">
														<p class="form-submit">
															<input name="submit" id="submit" value="Submit Review" type="submit">
															<input name="comment_post_ID" value="53" id="comment_post_ID" type="hidden">
							...
							<div class="related products">
								...
								<ul class="products">
									<li class="post-22 product type-product status-publish hentry first instock">
										<div class="product-wrap">
											<a href="#">
												<img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/T_4_front-150x150.jpg" class="attachment-shop_catalog wp-post-image" alt="T_4_front">
											</a>
											<a href="#" rel="nofollow" data-product_id="60" data-product_sku="" class="add_to_cart_button button product_type_simple">Add to cart</a>
										</div>
										<a href="#">
									...
									<li class="post-60 product type-product status-publish hentry last instock">
										<div class="product-wrap">
											<a href="#">
											<img src="http://skywarriorthemes.com/gameaddict/wp-content/uploads/2013/06/hoodie_6_front-150x150.jpg" class="attachment-shop_catalog wp-post-image" alt="hoodie_6_front" height="150" width="150"> </a>
											<a href="#" rel="nofollow" data-product_id="60" data-product_sku="" class="add_to_cart_button button product_type_simple">Add to cart</a>
										</div>
										<a href="#">
											<h3>Woo Logo</h3>
