	...
	<body class="home page page-id-26 page-template page-template-tmp-no-title-php">
		...
		<div id="myModalL" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="title_wrapper container">
					<div class="span12">
						<div class="span6">
							<h1>Etiam massa mauris fermentum a congue id</h1>
						</div>
						<div class="breadcrumbs">
							<strong><a href="#">Home</a> / <a href="#">Blog</a>  / Etiam massa mauris fermentum a congue id</strong>
						</div>
					</div>
			</div>
					...
					<div class="span8">
						<div class="blog-post">
							<div class="blog-image">
								<a href="#"><img src="./img/defaults/817x320.jpg" class="attachment-817x320 wp-post-image" alt="2" height="320" width="817"></a>
								<div class="blog-date">
							...
							<!-- blog-image -->
							<div class="">
								<h2>Etiam massa mauris fermentum a congue id</h2>
							</div>
							<!-- blog-content -->
							<div class="blog-info">
							...
							<div class="blog-content">
								...
								<blockquote>
									<p>Curabitur lorem mauris, dictum et tempus eu, feugiat pharetra sapien. Donec vel turpis orci, ut congue tortor. Aenean sed interdum quam. Vivamus laoreet posuere pharetra. Donec quis nisi nec nulla malesuada scelerisque vitae ac turpis. In eget elit eu risus gravida adipiscing.</p>
								</blockquote>
						...
						<div class="author-block wcontainer">
							<img alt="" src="http://1.gravatar.com/avatar/38d93eff4c0db34aa79f07cf9ad1a89c?s=250&d=http%3A%2F%2F1.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D250&r=G" class="avatar avatar-250 photo" height="250" width="250">                
						...
						<div class="comment-form">
							...
							<ul class="comment-list">
								<li class="comment">
									<div class="wcontainer">
										...
										<div class="comment-body">
											<div class="comment-author"> <span class="comment-info">admin</span></div>
											<i><small>Jun 18, 2013 @ 8:53 am</small> </i><br>
											<p>Awesome theme!</p>
											<a class="comment-reply-link button-small" href="#">Reply</a>        
										</div>
										<div class="clear"></div>
									</div>
								</li>
								...
								<li class="comment">
									<div class="wcontainer">
										<img alt="" src="http://0.gravatar.com/avatar/626c4d529d58fb2375290defe0461b98?s=80&amp;d=http%3A%2F%2F0.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D80&amp;r=G" class="photo avatar avatar-80 photo" height="80" width="80">            
										<div class="comment-body">
											<div class="comment-author"> <span class="comment-info">Limakus</span></div>
											<i><small>Jan 12, 2014 @ 17:19 pm</small> </i><br>
											<p>Really Cool</p>
											<a class="comment-reply-link button-small" href="#">Reply</a>        
										</div>
										<div class="clear"></div>
								...
								<div class="formcontainer">
									<form id="commentform" action="#" method="post" class="contact comment-form">
										...
										<div id="form-section-url" class="form-section input-prepend">
											...
											<input id="url" placeholder="Website" name="url" value="" size="30" maxlength="50" tabindex="5" type="text">
										</div>
