...
<?php 
    ...
    if($item == 1) {
    	$alltime = "<div class='full'><div class='wrapper'><div class='center'>
            		<h2 style='font-size: 30px; margin-bottom: 20px;'>web development</h2><p style='font-size: 16px;'>In today's technology-centered world, 
                    ...
                    <p>We are a web design company that specializes in distinctive and innovative 
                    ...
                    creative and comprehensive.</p><p>Your business vision and goals will always be at the forefront of our designs. We aim to create an excellent user 
                    ...
                    materials, your online impact will be remarkable.</p><p>We work with customers of all sizes across a variety of industries, and our services are 
                    customizable according to your needs. Your website will optimized for best performance, from copywriting options to integrated marketing analysis tools. 
                    Thanks to us, your competition will be comprehensively beaten in no time!</p><p><a href='mailto:reservations@dinnerwithgayle.com'>
                    Book your dinner with Gayle to get started!</a></p></div></div></div>";
    }  else if ($item == 2) {
    	$alltime = "<div class='full'><div class='wrapper'><div class='center'>
            		<h2 style='font-size: 30px; margin-bottom: 20px;'>e-commerce</h2><p style='font-size: 16px;'>We understand that if your business wants to expand to sell your products online, your business hinges directly on the fluidity and functionality 
                    of your website. White Media focuses on creating an easy to use and innovative user interface, that will attract new customers. We implement every e-commerce website 
                    ...
                    solutions we will figure out the best way to take your business to new heights!</p><p><a href='mailto:reservations@dinnerwithgayle.com'>
                    Book your dinner with Gayle to get started!</a></p></div></div></div>";
    } else if ($item == 3) {
    	$alltime = "<div class='full'><div class='wrapper'><div class='center'>
            		<h2 style='font-size: 30px; margin-bottom: 20px;'>ios & android app design</h2><p style='font-size: 16px;'>Let us help develop your iOS and Android Applications.  Our dinner table contains expert app developers across both platforms 
                    are this group are constantly looking for new and interesting Application projects to work on.  After submitting your project idea to us, we’ll review it and have 
    	...
    	$alltime = "<div class='full'><div class='wrapper'><div class='center'>
            		<h2 style='font-size: 30px; margin-bottom: 20px;'>graphic design</h2><p style='font-size: 16px;'>Our custom designs have a long standing reputation of effectively summarizing a company’s business philosophy while clearly identifying areas 
                    of expertise into their customized logo, corporate identities and brand creation services.  Branding is the process of turning your business and services into a <br />
					household name by establishing a unique presence that makes you stand out from your competitors.  With the use of a unique logo, designed by the team at Dinner With 
    	...
    	$alltime = "<div class='full'><div class='wrapper'><div class='center'>
            		<h2 style='font-size: 30px; margin-bottom: 20px;'>digital marketing</h2><p style='font-size: 16px;'>The team at Gayle understands the importance of social & digital marketing and, therefore, urges all our clients to utilize it to drive 
    	...
    	$alltime = "<div class='full'><div class='wrapper'><div class='center'>
            		<h2 style='font-size: 30px; margin-bottom: 20px;'>creative</h2><p style='font-size: 16px;'>The Gayle team are aiming to be the best in the web, and we want to take you with us! Our collaborative, results-driven process is built 
                    ...
                    earnest.</p><p>Our mantra at Gayle is a simple one - We believe in doing what we do well versus claiming to be experts in everything. 
			...
			<div class="wrapper">
				...
				<nav>
					<ul>
						...
						<li class="current"><a href="index.php#menu">our menu</a></li>
